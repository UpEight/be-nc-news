    ...
    describe('/users', () => {
      ...
      it('GET /:notAUsername responds with status 404, User not found', () => {
        return request(app)
          ...
          .expect(404)
          .then(({ body: { msg } }) => {
            expect(msg).to.equal("User 'notAUsername' not found");
          });
      });
      describe('INVALID METHODS', () => {
    ...
    describe('/articles', () => {
      ...
      it('GET /:articleIdDoesNotExist responds with 404, Article not found', () => {
        return request(app)
          ...
          .expect(404)
          .then(({ body: { msg } }) => {
            expect(msg).to.equal('Article 15 not found');
          });
      });
      ...
      describe('/:article_id', () => {
        ...
        it('GET /comments responds with 404, Article not found if /:article_id does not exist', () => {
          return request(app)
            ...
            .then(({ body: { msg } }) => {
              expect(msg).to.equal(
                'Unable to get comments - article 15 not found'
              );
            });
        });
    ...
    describe('/comments', () => {
      ...
      it('PATCH /:commentIdDoesNotExist responds with 404, Comment not found', () => {
        return request(app)
          ...
          .expect(404)
          .then(({ body: { msg } }) => {
            expect(msg).to.equal('Comment 25 not found');
          });
      });
      it('PATCH /notAnId responds with status 400, Bad request', () => {
        return request(app)
      ...
      it('DELETE /comment-does-not-exist responds with 404: Not found', () => {
        return request(app)
          ...
          .expect(404)
          .then(({ body: { msg } }) => {
            expect(msg).to.equal('Comment 1000 not found');
          });
      });
      describe('INVALID METHODS', () => {
